...
LemmatizePython::LemmatizePython(){
           this->lemtz = new RdrLemmatizer();
           this->lemtz->LoadBinary("lem-me-en.bin");
       };

char * LemmatizePython::LemmatizeWord(const char *acWord){
    char *hello;
    this->lemtz->Lemmatize(acWord, hello);
    return hello;
}
